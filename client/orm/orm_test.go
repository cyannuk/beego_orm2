...
import (
	...
	"github.com/cyannuk/beego_orm2/v2/client/orm/hints"
...
func TestTM(t *testing.T) {
	...
	throwFail(t, err)
	throwFail(t, AssertIs(recTM.TMPrecision1.String(), "2020-08-07 02:07:04.123 +0000 GMT"))
	throwFail(t, AssertIs(recTM.TMPrecision2.String(), "2020-08-07 02:07:04.1235 +0000 GMT"))
}
...
func TestPSQueryBuilder(t *testing.T) {
	...
	RegisterModel(new(Profile), new(Post), new(Tag), new(PostTags))
	var user User
	var l []userProfile
	o := NewOrm()
